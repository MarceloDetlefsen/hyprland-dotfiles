...
hl.bind(mod .. " + CTRL + D", function() M.toggle("Reading Mode") end, { description = "Toggle Reading Mode"    })
hl.bind(mod .. " + CTRL + N", function() M.toggle("Night Light")  end, { description = "Toggle Night Light"     })
