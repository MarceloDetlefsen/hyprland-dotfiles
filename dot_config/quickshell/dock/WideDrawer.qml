...
PanelWindow {
    ...
    function launchApp(command, needsTerminal) {
        ...
        Qt.callLater(() => {
            if (needsTerminal) {
                Quickshell.execDetached(["sh", "-lc", "kitty -e " + command])
            } else {
                    ...
                    RowLayout {
                        ...
                        RowLayout {
                            ...
                            Image {
                                    id: avatarImg
                                    anchors.fill: parent
                                    source: Lib.Configuration.profileImageOverride !== ""
                                        ? (Lib.Configuration.profileImageOverride.startsWith("file://")
                                            ? Lib.Configuration.profileImageOverride
                                            : "file://" + Lib.Configuration.profileImageOverride)
                                        : "../profile.jpg"
